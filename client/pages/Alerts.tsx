...
const alerts: Alert[] = [
  {
    id: "1",
    title: "Temperatura Elevada - Forno 2",
    description: "Temperatura acima do limite operacional seguro",
    type: "critical",
    category: "equipment",
    source: "Sensor TMP-F2-001",
    ...
    details: {
      currentValue: "925°C",
      threshold: "900°C",
      equipment: "Forno Industrial 02",
      location: "Setor C - Tratamento"
    }
  },
  {
    id: "2",
    title: "Baixa Eficiência - Linha 1",
    description: "Eficiência da linha abaixo da meta estabelecida",
    type: "warning",
    category: "production",
    ...
    details: {
      currentValue: "72%",
      threshold: "85%",
      equipment: "Linha de Montagem 1",
      location: "Setor A - Produção"
    }
  },
  {
    id: "3",
    title: "Manutenção Vencida - Compressor",
    description: "Manutenção preventiva em atraso",
    type: "warning",
    ...
    actualResolution: "2024-01-23T16:00:00",
    impact: "low",
    details: {
      equipment: "Compressor Principal",
      location: "Setor E - Utilidades"
    }
  },
  {
    id: "4",
    title: "Falha de Qualidade - Lote LOT-240122",
    description: "Taxa de defeitos acima do aceitável",
    type: "critical",
    category: "quality",
    source: "Controle de Qualidade",
    ...
    details: {
      currentValue: "8.5%",
      threshold: "5.0%",
      equipment: "Linha de Produção B",
      location: "Setor B - Produção"
    }
  },
  {
    id: "5",
    title: "Operador Ausente - Turno da Noite",
    description: "Falta não programada de operador chave",
    type: "warning",
    category: "safety",
    ...
    status: "resolved",
    priority: "medium",
    assignedTo: "Supervisor Noturno",
    actualResolution: "2024-01-22T23:00:00",
    impact: "medium",
    details: {
  ...
  {
    id: "6",
    title: "Vibração Anormal - Robô Soldador",
    description: "Níveis de vibração fora do padrão normal",
    type: "warning",
    category: "equipment",
    source: "Sensor VIB-RS-003",
    timestamp: "2024-01-22T10:15:00",
    status: "dismissed",
    priority: "low",
    impact: "low",
    details: {
      currentValue: "3.2 mm/s",
      threshold: "3.0 mm/s",
      equipment: "Robô Soldador 03",
      location: "Setor D - Solda"
    }
  }
];
