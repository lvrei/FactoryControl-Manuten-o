            ...
            <div className="p-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Cor de Identificação (Stock)</label>
                    <div className="flex gap-2">
                      <input
                        type="color"
                        value={newFoamType.stockColor}
                        onChange={(e) => setNewFoamType(prev => ({ ...prev, stockColor: e.target.value }))}
                        className="w-16 h-10 border rounded-lg bg-background"
                      />
                      <input
                        type="text"
                        value={newFoamType.stockColor}
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Cor usada para identificação visual dos blocos no stock
                    </p>
                  </div>
