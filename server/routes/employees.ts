  ...
  try {
    ...
    await query(
      ...
      [
        ...
        d.phone || null,
        d.hireDate || null,
        d.skills ? JSON.stringify(d.skills) : "[]",
        d.certifications ? JSON.stringify(d.certifications) : "[]",
        d.machineOperatingLicense
          ? JSON.stringify(d.machineOperatingLicense)
          : "[]",
  ...
  try {
    ...
    await query(
      ...
      [
        ...
        d.phone,
        d.hireDate,
        d.skills ? JSON.stringify(d.skills) : undefined,
        d.certifications ? JSON.stringify(d.certifications) : undefined,
        d.machineOperatingLicense
          ? JSON.stringify(d.machineOperatingLicense)
          : undefined,
        d.currentAssignment,
